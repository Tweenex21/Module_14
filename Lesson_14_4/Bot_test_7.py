...
import asyncio
from Module_14.Lesson_14_4.crud_functions import get_all_products, initiate_db
...
async def get_buying_list(message):
    ...
    media = MediaGroup()
    for i in products:
        pic = open(f'ForBot{i[0]}.jpg', 'rb')
        media.attach_photo(pic, f'Название: {i[1]} | Описание: описание {i[2]} | Цена: {i[3]}')
